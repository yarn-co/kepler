...
var Stickersheet = module.exports = function(options) {
    ...
    //     SVG_Object,
    //     dpi,
    //     spacing // spacing is not declared in the old index.js
    //      need to find a correct standard default
    // }
    ...
    var trixelFilter = options.SVG_Object.element.getElementById("f");
    options.SVG_Object.element.removeChild(trixelFilter);
    
    // Make it easier to grab values from the original trixel's viewBox
    var viewBoxTmp = options.SVG_Object.element.getAttribute("viewBox");
    ...
    function dupTrixel() {
        ...
        dupTrxl.innerHTML = options.SVG_Object.element.innerHTML;
        
        dupTrxl.setAttribute("viewBox", options.SVG_Object.element.getAttribute("viewBox"));

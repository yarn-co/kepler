...
var Stickersheet = module.exports = function(trixel) {
    ...
    */
    ...
    var paddingBetweenTrixels = pageWidth * 0.03; // Best guess based on mockup
    var paddingFromPageSides = pageWidth * 0.025; // Best guess based on mockup
    var rowOffset = pageHeight * 0.265;

    var t1X = paddingFromPageSides;
    var t1Y = -pageHeight/2 + trixelHeight/2 + paddingFromPageSides;

...
var Stickersheet = module.exports = function(trixel, options) {
    ...
    console.log("page width = ", pageWidth, "page height = ", pageHeight, "dpi  = ", dpi);
    ...
    */
    ...
    console.log("We made it all the way through Bill's stickersheet...");

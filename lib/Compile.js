...
var Compile = module.exports = function (options) {
      ...
      function createSVG(width) {
            ...
            // Set height/width, at least for Safari
            svgElem.setAttribute("height", boxHeight + 'px');
            svgElem.setAttribute("width",  boxWidth  + 'px');
            ...
            if (options.mergePaths) {
                ...
                internals.mergePathsByColor(svgElem);
            }
...
internals.mergePathsByColor = function(svg) {

...
var Compile = module.exports = function (options) {
      ...
      */
      ...
      function makeItAQuantumCard(newGirl, cardData) {
        ...
        // script.innerHTML ="WebFontConfig = {\n"+
        ...
        style.innerHTML = "@font-face {\n" +
                          ...
                          "\tsrc: url('/styles/fonts/RobotoSlab-Regular.ttf') format('truetype');\n" +
                          "}\n" +
                          "\n"+
                          "text {\n"+
                          "\tstroke: none;\n"+
        ...
        newText.innerHTML = "WET, HOT, AMERICAN POOL BOY";
        
        newText.setAttribute("text-anchor", "middle");
        newText.setAttribute("y", "-20%");

        newText.setAttribute("font-family", "Roboto Slab");
        newText.setAttribute("font-size","18px");
        newText.setAttribute("text-transform", "uppercase");
        
        newGirl.element._childNodes.push(newText);

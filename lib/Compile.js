...
var Compile = module.exports = function (options) {
      ...
      if(options.quantumCard) {
        console.log(options.quantumCardData);
      ...
      */
      ...
      function makeItAQuantumCard(newGirl, cardData) {
        ...
        style.innerHTML = "@font-face {\n" +
                          ...
                          "\tsrc: url('http://0.0.0.0:3007/styles/fonts/RobotoSlab-Light.ttf');\n" +
                          "}\n" +
                          "\n"+
                          "text {\n"+
                          "\tstroke: none;\n"+
        ...
        polyUp.setAttribute("points","0,-159 11.6913,-152.25 11.6913,-138.75 0,-132 -11.6913,-138.75 -11.6913,-152.25");
        ...
        polyDown.setAttribute("points","0,159 11.6913,152.25 11.6913,138.75 0,132 -11.6913,138.75 -11.6913,152.25");
        ...
        name.setAttribute("font-size","18px");
        ...
        move.innerHTML = cardData.move;
        move.setAttribute("text-anchor", "middle");
        move.setAttribute("y", "43.4%");
        move.setAttribute("font-family", "Roboto Slab");
        move.setAttribute("font-size","12px");
        move.setAttribute("text-transform", "uppercase");
